...
x=load(strcat('F:\cleo\SCP\Cleo\FORTRAN\VERSIONES\Jacobi_v4\Salida\outputPar',num2str(i,'%3.3d'),'.txt'));
...
imwrite(animated,cmap,'F:\cleo\SCP\Cleo\FORTRAN\VERSIONES\Jacobi_v4\Salida\Heat_2D.gif','DelayTime',step,'LoopCount',inf); 
