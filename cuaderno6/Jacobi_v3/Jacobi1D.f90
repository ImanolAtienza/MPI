...
!
      ...
      double precision gconf(4) , conv(3), chip(6), cooling(5)
      ...
      if (myid .eq. 0) then
           call readParam(gconf, conv, chip, cooling)
      ...
      call onedinit( a, b, fheat, nx, ny, s, e, tmp_ambiente,chip, factor_escala, fcool,cooling)
